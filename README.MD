...
![Age vs. Retention Count ](Visualizations/Age_vs.Player%20Retention (Count)%20(1).png)

![Age vs. Retention Rate ](Visualizations/Age_vs.Retention_Rate.png)
...
![Win Average % (bucketed) vs. Player Count ](Visualizations/Win_Average %_(bucketed)_vs._Player_Count.png)
...
![Win Percentile vs. Retained Player Retention Rate.png ](Visualizations/Win_Percentile vs._Retained_Player_Retention_Rate.png)
